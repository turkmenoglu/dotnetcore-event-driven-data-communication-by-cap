...
builder.Services.AddCap(options =>
{
    ...
    options.UseRabbitMQ(options =>
    {
        options.ConnectionFactoryOptions = options =>
        {
            ...
            options.Port = 5672;
            // options.Uri = new Uri("amqps://hkhjerrt:ijgxp_ibZPQ8NUQ2NrcPsfBEVMhET5dw@hornet.rmq.cloudamqp.com/hkhjerrt");
            // options.Ssl.Enabled = true;
            // options.HostName = "hornet.rmq.cloudamqp.com";
            // options.UserName = "hkhjerrt";
            // options.Password = "ijgxp_ibZPQ8NUQ2NrcPsfBEVMhET5dw";
        };
    });
});
